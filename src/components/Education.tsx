...
const Education = () => {
  ...
  return (
    <section id="education" className="py-16 bg-gradient-to-br from-yellow-50 to-green-50 px-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[#88B04B] mb-4 font-poppins">
            Belajar Bertani Itu Seru!
          </h2>
          <p className="text-gray-600 max-w-3xl mx-auto font-nunito text-lg">
            ...
            <div className="grid grid-cols-2 gap-6">
              {educationPoints.map((point, index) => (
                <div key={index} className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="bg-[#88B04B] p-3 rounded-full w-fit mb-4">
                    <point.icon className="h-6 w-6 text-white" />
                  </div>
                  <h3 className="font-semibold text-gray-800 mb-2 font-poppins">{point.title}</h3>
                  <p className="text-gray-600 text-sm font-nunito">{point.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="relative aspect-video bg-gray-200 rounded-xl overflow-hidden">
              <img src={edukasi2} alt="foto-edukasi-keluarga" />
            </div>

            <div className="space-y-6">
              <div className="bg-gray-50 p-6 rounded-xl">
                <h4 className="font-semibold text-[#88B04B] mb-2 font-poppins text-justify">Program Edukasi Pelajar</h4>
                <p className="text-gray-600 font-nunito text-justify">
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                <h4 className="font-semibold text-[#88B04B] mb-2 font-poppins text-justify">Workshop Keluarga & Outing</h4>
                <p className="text-gray-600 font-nunito text-justify">
